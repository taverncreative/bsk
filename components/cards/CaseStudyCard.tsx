...
export default function CaseStudyCard({ caseStudy }: { caseStudy: CaseStudy }) {
  ...
  return (
    <Link 
      ...
      className="group flex flex-col h-full bg-paper-raised border border-paper-border rounded-2xl overflow-hidden hover:border-brand-gold/50 hover:bg-paper-raised/90 transition-all duration-300 relative"
    >
      ...
      <div className="p-8 flex flex-col h-full z-10">
        <div className="flex justify-between items-start mb-6">
          <div className="flex flex-wrap gap-2">
            <span className="px-3 py-1 bg-paper rounded-full text-xs font-semibold text-brand-gold border border-brand-gold/20">
              {industry}
            </span>
            <span className="px-3 py-1 bg-paper rounded-full text-xs font-medium text-ink-muted border border-paper-border">
              {town}
            </span>
          </div>
        ...
        <h3 className="text-2xl font-bold text-ink mb-4 group-hover:text-brand-gold transition-colors leading-tight">
          {caseStudy.title}
        </h3>
        
        <div className="mb-6">
          <p className="text-sm text-ink-muted font-bold mb-1 uppercase tracking-wider">The Result</p>
          <p className="text-ink leading-relaxed font-medium">
            "{headlineResult}"
          </p>
        </div>
        
        <div className="mt-auto pt-6 border-t border-paper-border">
          <p className="text-sm text-ink-muted font-bold mb-1">Services Deployed</p>
