        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {industries.map((industry, index) => (
            <Reveal key={industry.id} delay={index * 0.05}>
              <div className="bg-paper-raised border border-paper-border rounded-xl p-6 transition-all duration-300 hover:border-brand-gold hover:shadow-[0_0_40px_rgba(214,173,103,0.15)] flex flex-col h-full group">
                ...
                <div className="pt-4 border-t border-paper-border mt-auto">
                  <Link 
