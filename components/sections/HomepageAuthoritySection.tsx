...
export default function HomepageAuthoritySection() {
  return (
    <section className="py-28 bg-paper border-t border-paper-border border-b relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16">
          <Reveal delay={0.1}>
            <div className="flex flex-col group h-full">
              ...
              <h3 className="text-2xl font-bold text-ink mb-4 group-hover:text-brand-gold transition-colors">
                Website Foundations
              </h3>
              ...
              <div className="mt-8 flex flex-col gap-3">
                ...
                <Link href="/business-automation" className="text-ink-muted font-bold text-sm hover:text-brand-gold transition-colors">
          ...
          <Reveal delay={0.2}>
            <div className="flex flex-col group h-full relative">
              <div className="hidden md:block absolute -left-8 top-10 bottom-10 w-px bg-paper-raised" />
