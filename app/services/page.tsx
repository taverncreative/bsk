          ...
          <div className="flex flex-col divide-y divide-neutral-800/50">
            ...
            <div className="py-[120px] grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <Reveal delay={0.2} className="order-1 lg:order-2">
                <div className="bg-neutral-950 border border-neutral-800 rounded-2xl p-8 aspect-square lg:aspect-auto lg:h-full flex items-center justify-center">
                  ...
                  <div className="w-full max-w-sm">
                    <div className="bg-neutral-900 border border-neutral-800 rounded-xl p-6 shadow-2xl">
                      ...
                      <div className="space-y-4">
                        <div className="h-10 w-full bg-neutral-950 border border-neutral-800 rounded"></div>
                        <div className="h-10 w-full bg-neutral-950 border border-neutral-800 rounded"></div>
                        <div className="h-24 w-full bg-neutral-950 border border-neutral-800 rounded"></div>
            ...
            <div className="py-[120px] grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <Reveal className="order-1 lg:order-1">
                <div className="bg-neutral-950 border border-neutral-800 rounded-2xl p-8 aspect-square lg:aspect-auto lg:h-full flex items-center justify-center relative">
                  <div className="w-full max-w-sm space-y-4">
