...
export const metadata: Metadata = {
  ...
  description:
    '£280 websites, £45/hour SEO, £15/month hosting. AI made the work faster, and we pass the saving on. SEO experts, graphic design background, mobile-first, performance prioritised.',
  alternates: {
