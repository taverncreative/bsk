...
export const metadata: Metadata = {
  ...
  description:
    'Founder-led digital agency for everyday Kent businesses. £280 websites, £45/hour SEO, automations on the brief. AI made the work faster — we passed the saving on.',
  alternates: {
